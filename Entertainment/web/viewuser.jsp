...
%>
<h2 align="center"><font><strong>View Users</strong></font></h2>
...
String sql ="SELECT * FROM userreg1";
...
<td class="text-center">
    <a href="deleteuser.jsp?d=<%=resultSet.getString("id")%>" class="btn btn-danger">Delete</a>
</td>
