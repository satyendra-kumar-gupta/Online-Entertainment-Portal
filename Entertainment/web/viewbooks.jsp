...
<html>
    ...
    <body>
        ...
        <br>
        <br>
        <h2 style="text-align: center; color: red">View Books</h2>
...
rs = stmt.executeQuery("select bid,bname from books");
...
<TD><a href="viewbooks1.jsp?bid=<%=rs.getInt(1)%>">
<img src="DisplayImg1?bid=<%=rs.getInt(1)%>" width="95%" height="50%" />
</a></TD>
</TR>

<TR align="center">

<TD><a href="viewbooks1.jsp?bid=<%=rs.getInt(1)%>"><%=rs.getString(2)%></a></TD>
</TR>
