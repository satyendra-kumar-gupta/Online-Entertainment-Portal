 <%-- 
    Document   : addmovies
    Created on : 25 Jan, 2019, 8:38:34 PM
    Author     : Satyendra
--%>
...
<html>
    ...
    <body>
       <!--header1 start-->
        ...
        <br>
        <br>
        <form method="post" action="Addmoviesdb" enctype="multipart/form-data">
            <center>
            <table border="1" width="30%" cellpadding="5">
                <thead>
                    <tr>
                        <th colspan="2">Add Movies</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>Trailer:</td>
                        <td><input type="file" name="mtrailer"  /></td>
                    </tr>
                    <tr>
